...
We have `r prettyNum(nrow(mtcars), big.mark = ".", decimal.mark = ",")` cars.
...
------------- | -------------
`r min(inflation$perception)`  | `r min(inflation$expectation)`
`r max(inflation$year)`  | `r max(inflation$expectation)`
